    ...
    public class DAL
    {
        ...
        public DataTable GetAllCases()
        {
            ...
            try
            {
                ...
                cmd.CommandText = "SELECT docnum,newcarid,Branch,casetypecode,scheduledstart,new_solution_code,description,SAPExportDate,CRMImportDate,CRM_ERROR_MSG FROM [SAP_CRM].[dbo].[CloseCases] WHERE CRMImportDate IS NULL ";
